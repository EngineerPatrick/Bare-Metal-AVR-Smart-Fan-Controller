...
*
*	@details Module to configure a display to show 8x8
*	pixels characters and digits.
*
*	All the pattern bitmaps are saved in program memory
*	to restrain RAM usage for MCU applications.
*
*/
...
/**
*
*	@brief	Writes the standard option on the display.
*
*	@retval	DISPLAY_ERR_OK			If no error occurs
*	@retval	DISPLAY_ERR_SSD			If an error with the SSD1306 display occurs
*
*   @post   If an error with the SSD1306 display occurs the correct execution is not guaranteed
*	@post 	On success the display shows the word "STANDARD" at the selected position of a 8x16 grid
*
*/
...
/**
*
*	@brief	Writes the advanced option on the display.
*
*	@retval	DISPLAY_ERR_OK			If no error occurs
*	@retval	DISPLAY_ERR_SSD			If an error with the SSD1306 display occurs
*
*   @post   If an error with the SSD1306 display occurs the correct execution is not guaranteed
*	@post 	On success the display shows the word "ADVANCED" at the selected position of a 8x16 grid
*
*/
...
*
*	@param	index					Index of the current fan curve node
*
*	@retval	DISPLAY_ERR_OK			If no error occurs
...
*   @post   If an error with the SSD1306 display occurs the correct execution is not guaranteed
*	@post 	On success the display shows the index as "NODE XX" at the selected position of a 8x16 grid
*
*/
...
*
*   @post   If an error with the SSD1306 display occurs the correct execution is not guaranteed
*	@post 	On success the display shows the words "TEMP      . °C" at the selected position of a 8x16 grid
*	@post 	On success the display shows the words "SPEED      RPM" at the selected position of a 8x16 grid
*
*/
...
*   @post   If passed parameter is invalid the transmission is not started
*   @post   If an error with the SSD1306 display occurs the correct execution is not guaranteed
*	@post 	On success the display shows the digits "XX X" at the selected position of a 8x16 grid
*
...
*   @post   If passed parameter is invalid the transmission is not started
*   @post   If an error with the SSD1306 display occurs the correct execution is not guaranteed
*	@post 	On success the display shows the digits "XXXX" at the selected position of a 8x16 grid
*
*/
...
*	@post 	On success the blink parameters are configured and display_blink_switch is required to be polled
*
*/
